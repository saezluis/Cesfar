    ...
    <section class="grupo">
      <article class="fondo">
        <div class="caja base-100 tablet-50 web-50">
          <h1>Cotización</h1>
          <h4>
            Ud. puede realizar su cotización mediante este
            formulario web, el cual responderemos a la brevedad.
          </h4>
          <form action="procesar-cotizacion.php" method="post" id="coti">
            ...
            <textarea name="cotizacion" placeholder="Cotización (Especificar marca, principio activo y cantidad):" required></textarea>
